            ...
            <nav className="hidden md:block">
              <ul className="flex space-x-6 text-sm">
                ...
                <li className="relative" ref={dropdownRef}>
                  ...
                  {techDropdownOpen && (
                    <div
                      className="absolute left-0 mt-2 w-[800px] bg-white/60 backdrop-blur-sm shadow-lg rounded-md overflow-hidden z-50"
                      ...
                      <div className="flex">
                        {techLinks.map((link, index) => (
                          <Link key={index} href={link.href} className="block hover:bg-gray-100/80 flex-1 group">
                            <div className="p-4 border-r last:border-r-0 border-gray-100 h-full">
